...
<?php 
    ...
    $alert_search = "SELECT * FROM notification where alert_name='Shater1' and days_left>0";
...
<?php
   ...
   $user_search2 = "SELECT * FROM readings WHERE read_user = 'Shater1'";
   ...
   <ul class="navbar-nav ml-auto">
     ...
     <li class="nav-item dropdown">
       <a class="nav-link" data-toggle="dropdown" href="#">
         ...
         <span class="badge badge-warning navbar-badge"><?php echo $alert_value;?> </span>
       </a>
       <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <?php
         ...
         <?php
                   ...
                   ?>
         <div class="dropdown-divider"></div>
         <a href="#" class="dropdown-item dropdown-footer">Notification expire automatically!</a>
       </div>
     </li>
   </ul>
 </nav>
         ...
         <div class="col-12">
           <div class="card">
             <div class="card-header">
               <h3 class="card-title">Shater 1 - Vegetable Shop</h3>
             </div>
             <!-- /.card-header -->
...
function due_amnt(){
  ...
  url : "../ajax/fetchunpaidshater1.php",
  type: "POST",
...
$('#load_details').on("click", function(e){
  ...
  url : "../ajax/fetch_unpaid_details_shater1.php",
  type: "POST",
    success: function(data){
